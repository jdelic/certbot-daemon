...
LOGGING = {
    ...
    "formatters": {
        ...
        "json": {
            '()': 'certbot_daemon.gunicorn_conf.CustomJsonFormatter',
            'prefix': '@cee: ',
        }
    },
    "handlers": {
...
# Preload the app because that allows us to spawn the apscheduler thread in the
# WSGI application module once (threads are not inherited by forked processes)
preload_app = True
